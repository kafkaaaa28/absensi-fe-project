...
import TableJadwalMahasiswa from './components/TableJadwalMahasiswa';
import LoadingPage from '../../../components/common/LoadingPage';
import { FaSearch } from 'react-icons/fa';

const JadwalMahasiswaPage = () => {
  const { jadwalSiswa, loadingJadwal } = useJadwal();
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
        <div>
          <h2 className="text-lg font-bold text-gray-800">Jadwal Kuliah</h2>
          <p className="text-gray-600 text-xs mt-0.5">Lihat jadwal perkuliahan Anda</p>
        </div>
      ...
      <TableJadwalMahasiswa jadwalSiswa={jadwalSiswa} loadingJadwal={loadingJadwal} searchTerm={searchTerm} getHariColor={getHariColor} />
    </div>
  );
};

export default JadwalMahasiswaPage;
