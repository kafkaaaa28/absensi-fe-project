...
const ModalAbsenPerkelasAsdos = ({ data, showModalAbsen, dataAbsenPerkelas, tanggalAbsen, fetchTanggalAbsen, onFetchAbsen, loading, handleChange, postTanggal, onClose }) => {
  useEffect(() => {
    if (data?.id_kelas) {
  ...
  return (
    <Modal show={showModalAbsen} onClose={onClose} size="3xl">
...
export default ModalAbsenPerkelasAsdos;
