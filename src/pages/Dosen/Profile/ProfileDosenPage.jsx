...
import { FaEnvelope, FaGraduationCap, FaUniversity, FaUserEdit, FaLock, FaBookOpen, FaCalendarAlt, FaCog, FaClipboardList, FaCertificate, FaBell } from 'react-icons/fa';
...
const ProfileDosenPage = () => {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      title: 'Mata Kuliah',
      action: () => navigate('/dashboardDosen/MatkulSaya'),
    },
    {
      icon: <FaCalendarAlt className="text-purple-500 text-2xl" />,
      title: 'Jadwal Mengajar',
      action: () => navigate('/dashboardDosen/jadwalSaya'),
    },
  ];
  ...
  const additionalMenus = [
    ...
    },
    {
      ...
      subtitle: 'Lihat history mengajar',
    },
    {
      icon: <FaCertificate className="text-yellow-500 text-xl" />,
      title: 'Sertifikasi',
      subtitle: 'Kelola sertifikat dosen',
    },
    {
