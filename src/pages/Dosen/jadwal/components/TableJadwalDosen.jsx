...
import { FaCalendarAlt, FaClock, FaMapMarkerAlt, FaBook, FaUsers, FaCode } from 'react-icons/fa';

const TableJadwalDosen = ({ dataJadwal, getHariColor, searchTerm }) => {
  const filteredData = dataJadwal.filter(
              ...
              <tr>
                <td colSpan="6" className="px-3 py-8 text-center">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-gray-500 text-xs font-medium">{dataJadwal.length === 0 ? 'Tidak ada jadwal' : 'Data tidak ditemukan'}</p>
...
export default TableJadwalDosen;
