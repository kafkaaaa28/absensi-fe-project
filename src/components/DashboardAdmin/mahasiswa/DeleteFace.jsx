...
const ModalDeleteFace = ({ modaldelete, data, onDelete, setModaldelete, loading }) => {
  const [selectedsiswa, setSelectedsiswa] = useState({ ...data });
  useEffect(() => {
...
export default ModalDeleteFace;
