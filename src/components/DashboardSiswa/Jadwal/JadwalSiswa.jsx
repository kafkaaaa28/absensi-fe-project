...
import { FaSearch, FaCalendarAlt, FaClock, FaMapMarkerAlt, FaBook, FaUsers, FaCode, FaUserGraduate } from 'react-icons/fa';
        ...
        {filteredData.length > 0 && (
          <div className="px-3 py-2.5 border-t border-gray-100 bg-gray-50">
            <p className="text-xs text-gray-600">
              Menampilkan <span className="font-medium">{filteredData.length}</span> dari <span className="font-medium">{data.length}</span> jadwal
            </p>
          </div>
        )}
      </div>
